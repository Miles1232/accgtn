...
# for action in [ "greeting",]:
    ...
    for i in range (len(number)):
        ...
        #
        frame_re_data = pred_angle_set[0]*100
        print(frame_re_data)
        ...
        frame_re_data = frame_re_data.cpu().detach().numpy()
